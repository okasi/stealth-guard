...
Stealth Guard does not integrate with any third-party analytics, advertising, or tracking services. If you use automatic proxy location naming, the extension may contact `ipinfo.io` or `ipapi.co` with the proxy endpoint you entered.
